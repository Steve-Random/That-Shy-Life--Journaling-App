...
class _JournalFeedScreenState extends State<JournalFeedScreen> {
  ...
  'content': 'Just setting up the unified workspace today. It feels great to see the java backend and Flutter web UI finally talking to each other smoothly.'
  },
  {
  'date': 'May 28, 2026',
  'title': 'Keeping It Natural',
  'content': 'Thinking about content styles today. There is something deeply powerful about keeping things raw, uscripted, and authentically human.'
  },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          ...
          //Centers nd bounds layout on web
    ...
    onPressed: (){
    //TODO: Take care of bavigation to entry creation later
    },
